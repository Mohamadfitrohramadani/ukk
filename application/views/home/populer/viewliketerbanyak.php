...
<body>
    ...
    <main>
        ...
        <div class="pop-atas">
            <center>
                <a href="<?= base_url('home/liketerbanyak') ?>">
                    <h4 class="section-title pop1">Like Terbanyak</h4>
                </a>
        ...
        <?php
        // Buat array baru untuk menyimpan indeks foto berdasarkan jumlah like
        $likeCountsIndexed = [];
        foreach ($likeCounts as $foto_id => $like_count) {
            $likeCountsIndexed[$foto_id] = $like_count;
        }

        // Urutkan array $data_foto berdasarkan jumlah like (diwakili oleh array $likeCountsIndexed) secara descending
        array_multisort($likeCountsIndexed, SORT_DESC, $data_foto);
                                ...
                                <div class="custom-block custom-block-full">
                                    ...
                                    <div class="custom-block-info">
                                        ...
                                        <div class="custom-block-bottom d-flex justify-content-between mt-3">
                                            <?php if ($this->session->userdata('role_id') == 1 || $this->session->userdata('role_id') == 2): ?>
                                                <?php
                                                $like_url = base_url('like/' . ($isLiked[$row->foto_id] ? 'unliket' : 'liket') . '/' . $row->foto_id);
