            ...
            <div class="container-fluid">
                <div class="col-lg-2">
                    <div class="card">
                        <div class="card-body">
                            <center>
                                <a href="<?= base_url('foto/tambahfoto') ?>">Tambah foto +</a>
                            </center>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data_foto as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="<?= base_url('assets/' . $row->lokasi_file); ?>" alt="Preview"
                                                        width="100">
                                                </td>
                                                <td>
                                                    <?php echo $row->judul_foto ?>
                                                </td>
                                                <td class="desfoto-cell">
                                                    <?php echo $row->des_foto ?>
                                                </td>

                                                <td>
                                                    <?php echo date('d F Y', strtotime($row->tgl_unggah)); ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('foto/update/') . $row->foto_id ?>"
                                                        class="btn btn-warning"><i class="fa fa-pencil"
                                                            aria-hidden="true"></i></a>
                                                    <a href="<?php echo base_url('foto/delete/') . $row->foto_id ?>"
