            ...
            <div class="container-fluid">
                <!-- <div class="col-lg-2">
                    <div class="card">
                        <div class="card-body">
                            <center>
                                <a href="<?= base_url('komen/tambahlike') ?>">Tambah like +</a>
                            </center>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table">
                                    ...
                                    <tbody>
                                        <?php
                                        foreach ($data_komen as $row) {

                                            ?>
                                            <tr>
                                                <td>
                                                    <?php echo $row->komen_id ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <?php echo $row->isi_komen ?>
                                                </td>
                                                <td>
                                                    <?php echo date('d F Y', strtotime($row->tgl_komen)); ?>
                                                </td>
                                                <td>
                                                    <!-- <a href=""
                                                        class="btn btn-warning"><i class="fa fa-pencil"
                                                            aria-hidden="true"></i></a> -->
                                                    <a href="<?php echo base_url('komentar/delete/') . $row->komen_id ?>"
