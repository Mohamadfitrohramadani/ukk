                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <?php echo form_open_multipart('user/Inputuser', 'class="user-form"'); ?>
                                <div class="form-group">
                                        <label for="input-4">Foto</label>
                                        <input type="file" name="foto_user" class="form-control" id="input-4"
                                            placeholder="Enter Your Nama Lengkap">
                                    </div>
                                    <div class="form-group ">
                                        <label for="input-1">Username</label>
                                        <input type="text" name="username" class="form-control" id="input-1"
                                            placeholder="Enter Your Name">
                                    </div>
                                    <div class="form-group">
                                        <label for="input-2">passwordword</label>
                                        <input type="password" name="password" class="form-control" id="input-2"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="namalengkap" class="form-control" id="input-4"
                                            placeholder="Enter Your Nama Lengkap">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="input-5">Role Id</label>
                                        <input type="text" name="role_id" class="form-control" id="input-5"
                                            placeholder="Enter Your Alamat">
                                    </div>
                                    <div class="form-group">
