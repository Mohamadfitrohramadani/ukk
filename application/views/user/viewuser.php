            ...
            <div class="container-fluid">
                <div class="col-lg-2">
                    <div class="card">
                        <div class="card-body">
                            <center>
                                <a href="<?= base_url('user/tambahuser') ?>">Tambah user +</a>
                            </center>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data_user as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="<?= base_url('assets/user/' . $row->foto_user); ?>" alt="Preview"
                                                        width="100">
                                                </td>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('user/update/') . $row->user_id ?>"
                                                        class="btn btn-warning"><i class="fa fa-pencil"
                                                            aria-hidden="true"></i></a>
                                                    <a href="<?php echo base_url('user/delete/') . $row->user_id ?>"
